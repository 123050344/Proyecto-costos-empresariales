...
{
    public partial class cedula_1 : Form
    {
        public cedula_1()
        {
            InitializeComponent();
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double materiaPrima = DatosCostos.MateriaPrima;
                double manoObra = DatosCostos.ManoObra;
                double costosIndirectos = DatosCostos.CostosIndirectos;
